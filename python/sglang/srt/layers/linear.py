...
class UnquantizedLinearMethod(LinearMethodBase):
    ...
    def create_weights(
        ...
        **extra_weight_attrs,
        ...
        print(f"Output partition size: {output_partition_sizes}\nOutput partition sizes sum: {sum(output_partition_sizes)}\nInput size per partition: {input_size_per_partition}", file=sys.stderr, flush=True)
        weight = Parameter(
            torch.empty(
...
class RowParallelLinear(LinearBase):
    ...
    def __init__(
        ...
        print(f"In linear mod init (later one ka init hi hai). Input size: {self.input_size}, Output size: {self.output_size}, input size per partition: {self.input_size_per_partition}, tp size: {self.tp_size}", file=sys.stderr, flush=True)
